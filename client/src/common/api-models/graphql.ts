...
export type ChatRoom = {
  ...
  isOngoingCall?: Maybe<Scalars['Boolean']['output']>;
...
export type Mutation = {
  ...
  chat__leaveChatRoom: Scalars['Boolean']['output'];
...
export type MutationChat__LeaveChatRoomArgs = {
...
export type Identity__ResetPinMutationVariables = Exact<{
  input: ResetPinInput;
}>;


export type Identity__ResetPinMutation = { __typename?: 'Mutation', identity__resetPin: boolean };
...
export type Chat__RoomMessagesQuery = { __typename?: 'Query', chat__roomMessages: { __typename?: 'ChatMessagesWithPagination', meta?: { __typename?: 'PagniationMeta', totalCount: number, hasNextPage: boolean } | null, nodes?: Array<{ __typename?: 'ChatMessage', _id: string, messageType?: ChatMessageType | null, text?: string | null, createdAt?: any | null, updatedAt?: any | null, createdBy?: { __typename?: 'User', _id: string, handle: string } | null, chatRoom?: { __typename?: 'ChatRoom', _id: string, handle?: string | null } | null }> | null } };
...
export const Identity__ResetPinDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"Identity__resetPin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResetPinInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"identity__resetPin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<Identity__ResetPinMutation, Identity__ResetPinMutationVariables>;
